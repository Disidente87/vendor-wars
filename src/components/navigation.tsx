        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <Link href="/" className="flex items-center space-x-2">
              <div className="flex items-center justify-center w-8 h-8 bg-gradient-to-r from-orange-600 to-red-600 rounded-lg">
                <Sword className="h-5 w-5 text-white" />
              </div>
              <span className="text-xl font-bold text-gray-900">Vendor Wars</span>
            </Link>
          </div>
