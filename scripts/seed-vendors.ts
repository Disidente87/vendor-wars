...
async function seedVendors() {
  console.log('🏪 Seeding vendors data in Supabase...')
  ...
  try {
    ...
    const vendors = [
      {
        ...
        category: 'pupusas',
        zone_id: '49298ccd-5b91-4a41-839d-98c3b2cc504b', // Centro
      ...
      },
      {
        ...
        category: 'tacos',
        zone_id: '61bace3e-ae39-4bb5-997b-1737122e8849', // Norte
      ...
      },
      {
        ...
        category: 'bebidas',
        zone_id: '100b486d-5859-4ab1-9112-2d4bbabcba46', // Sur
      ...
      },
      {
        ...
        category: 'otros',
        zone_id: '1ac86da4-0e2f-43fd-9dcb-0ac5a877048c', // Este
      ...
      },
      {
        ...
        category: 'otros',
        zone_id: 'a3914cda-f3c5-4c90-b7d2-d46d141f4bfc', // Oeste
    ...
    const users = [
      ...
      },
      {
        fid: 12347,
        username: 'cafe_aroma',
        display_name: 'Café Aroma',
        pfp_url: 'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=100&h=100&fit=crop&crop=face',
        ...
        verified_purchases: 145,
        credibility_tier: 'silver',
        vote_streak: 8,
        weekly_vote_count: 25,
        weekly_territory_bonus: 60
      },
      {
        fid: 12348,
        username: 'pizza_napoli',
        display_name: 'Pizza Napoli',
        pfp_url: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=100&h=100&fit=crop&crop=face',
        bio: 'Authentic Italian pizza with traditional recipes',
        follower_count: 0,
        following_count: 0,
        verified_addresses: [],
        battle_tokens: 890,
        credibility_score: 78,
        verified_purchases: 123,
        credibility_tier: 'silver',
        vote_streak: 6,
        weekly_vote_count: 18,
        weekly_territory_bonus: 45
      },
      {
        fid: 12349,
        username: 'sushi_express',
        display_name: 'Sushi Express',
        pfp_url: 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=100&h=100&fit=crop&crop=face',
        bio: 'Fresh sushi and Japanese cuisine made to order',
        follower_count: 0,
        following_count: 0,
        verified_addresses: [],
        battle_tokens: 1150,
        credibility_score: 92,
        verified_purchases: 167,
        credibility_tier: 'gold',
        vote_streak: 14,
        weekly_vote_count: 42,
        weekly_territory_bonus: 105
      }
    ]
    ...
    console.log('🎉 Vendors and users seeding completed successfully!')
  } catch (error) {
